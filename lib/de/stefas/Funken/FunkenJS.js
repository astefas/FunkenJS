...
class FunkenJS extends events {
  ...
  messageToJSON(messageToDeliver){
    if(messageToDeliver.indexOf("<") != -1 && messageToDeliver.indexOf(">") != -1){
      ...
      this.emit("de.stefas.funken.serial.data", JSON.stringify(obj));
    }
  }
